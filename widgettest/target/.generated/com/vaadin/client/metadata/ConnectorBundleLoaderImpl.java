      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setSuperClass(com.example.biprom.widgettest.widgettest.client.mycomponent.MyComponentState.class, com.vaadin.shared.AbstractComponentState.class);
            ...
            store.setClass("com.example.biprom.widgettest.widgettest.MyComponent", com.example.biprom.widgettest.widgettest.client.mycomponent.MyComponentConnector.class);
            ...
            store.setConstructor(com.example.biprom.widgettest.widgettest.client.mycomponent.MyComponentConnector.class, new Invoker() {
              public Object invoke(Object target, Object[] params) {
                return com.google.gwt.core.client.GWT.create(com.example.biprom.widgettest.widgettest.client.mycomponent.MyComponentConnector.class);
              }
            });
            store.setConstructor(com.example.biprom.widgettest.widgettest.client.mycomponent.MyComponentState.class, new Invoker() {
              public Object invoke(Object target, Object[] params) {
                return com.google.gwt.core.client.GWT.create(com.example.biprom.widgettest.widgettest.client.mycomponent.MyComponentState.class);
              }
            });
          ...
          private void load1() {
            ...
            store.setReturnType(com.example.biprom.widgettest.widgettest.client.mycomponent.MyComponentConnector.class, "getState", new Type(com.example.biprom.widgettest.widgettest.client.mycomponent.MyComponentState.class));
            ...
            store.setInvoker(com.example.biprom.widgettest.widgettest.client.mycomponent.MyComponentClientRpc.class, "alert",new Invoker() {
              public Object invoke(Object target, Object[] params) {
                ((com.example.biprom.widgettest.widgettest.client.mycomponent.MyComponentClientRpc) target).alert((java.lang.String) params[0]);
                return null;
              }
            });
            load2();
          ...
          private void load2() {
            ...
            store.setInvoker(com.vaadin.client.ui.button.ButtonConnector.class, "setErrorMessageAndLevel",new JsniInvoker() {
              protected native Object jsniInvoke(Object target, com.vaadin.client.JsArrayObject<Object> params) /*-{ 
                target.@com.vaadin.client.ui.button.ButtonConnector::setErrorMessageAndLevel(*)();
                return null;
              }-*/;
            });
            ...
            store.setParamTypes(com.example.biprom.widgettest.widgettest.client.mycomponent.MyComponentClientRpc.class, "alert", new Type[] {new Type(java.lang.String.class), });
            store.setParamTypes(com.example.biprom.widgettest.widgettest.client.mycomponent.MyComponentServerRpc.class, "clicked", new Type[] {new Type(com.vaadin.shared.MouseEventDetails.class), });
            store.setParamTypes(com.example.biprom.widgettest.widgettest.client.mycomponent.MyComponentServerRpc.class, "mouseDown", new Type[] {new Type(com.vaadin.shared.MouseEventDetails.class), });
            store.setParamTypes(com.example.biprom.widgettest.widgettest.client.mycomponent.MyComponentServerRpc.class, "mouseUp", new Type[] {new Type(com.vaadin.shared.MouseEventDetails.class), });
            ...
            store.setProxyHandler(com.example.biprom.widgettest.widgettest.client.mycomponent.MyComponentServerRpc.class, new com.vaadin.client.metadata.ProxyHandler() {
              public Object createProxy(final com.vaadin.client.metadata.InvokationHandler handler) {
                return new com.example.biprom.widgettest.widgettest.client.mycomponent.MyComponentServerRpc() {
                  public void clicked(com.vaadin.shared.MouseEventDetails p0) {
                    handler.invoke(this, com.vaadin.client.metadata.TypeData.getType(com.example.biprom.widgettest.widgettest.client.mycomponent.MyComponentServerRpc.class).getMethod("clicked"), new Object [] {p0, });
                  }
                  public void mouseDown(com.vaadin.shared.MouseEventDetails p0) {
                    handler.invoke(this, com.vaadin.client.metadata.TypeData.getType(com.example.biprom.widgettest.widgettest.client.mycomponent.MyComponentServerRpc.class).getMethod("mouseDown"), new Object [] {p0, });
                  }
                  public void mouseUp(com.vaadin.shared.MouseEventDetails p0) {
                    handler.invoke(this, com.vaadin.client.metadata.TypeData.getType(com.example.biprom.widgettest.widgettest.client.mycomponent.MyComponentServerRpc.class).getMethod("mouseUp"), new Object [] {p0, });
                  }
                };
              }
            });
          ...
          private void load5() {
            ...
            store.setPropertyType(com.example.biprom.widgettest.widgettest.client.mycomponent.MyComponentState.class, "text", new Type(java.lang.String.class));
          ...
          private void load6() {
            ...
            store.addOnStateChangeMethod(com.example.biprom.widgettest.widgettest.client.mycomponent.MyComponentConnector.class, new com.vaadin.client.metadata.OnStateChangeMethod(com.vaadin.client.ui.AbstractComponentConnector.class, "handleContextClickListenerChange", new String[] {"registeredEventListeners", }));
            ...
            store.addOnStateChangeMethod(com.vaadin.client.ui.button.ButtonConnector.class, new com.vaadin.client.metadata.OnStateChangeMethod("setErrorMessageAndLevel", new String[] {"errorMessage", "errorLevel", }));
          ...
          private native void loadNativeJs2(com.vaadin.client.metadata.TypeDataStore store) /*-{
            ...
            var data = {
              setter: function(bean, value) {
                bean.@com.example.biprom.widgettest.widgettest.client.mycomponent.MyComponentState::text = value;
              },
              getter: function(bean) {
                return bean.@com.example.biprom.widgettest.widgettest.client.mycomponent.MyComponentState::text;
              }
            };
            store.@com.vaadin.client.metadata.TypeDataStore::setPropertyData(Ljava/lang/Class;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(@com.example.biprom.widgettest.widgettest.client.mycomponent.MyComponentState::class, 'text', data);
